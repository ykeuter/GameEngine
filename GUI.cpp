...
void GameEngine::GUI::setMouseCursor(const std::string& imageFile) {
    m_context->getMouseCursor().setDefaultImage(imageFile);
}

void GameEngine::GUI::showMouseCursor() {
    m_context->getMouseCursor().show();
}

void GameEngine::GUI::hideMouseCursor() {
